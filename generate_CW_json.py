...
backscatter_coeff = {'SWIR':5*pow(10, -8), 'eSWIR':pow(10, -8)} # [1/m/sr]
...
for vis in visibilities:
    for band in wvls:
        for target in targets:
            ...
            output_data["Run Name"] = "./CW_output_csvs/" + name + ".csv"
            output_data["Filename"] = "./CW_input_jsons/" + name + ".json"
            output_data["Range Start [m]"] = 200
            output_data["Range End [m]"] = 15000
            output_data["Laser Power [W]"] = 2
            ...
            output_data["Integration Time"] = 0.1
